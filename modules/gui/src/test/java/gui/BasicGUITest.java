...
import net.hollowcube.gui.SinglePageGUI;
...
public class BasicGUITest {
    ...
    public void testGUIConstruct() {
        GUI gui = new SinglePageGUI(InventoryType.FURNACE, Component.text("test"));
        GUI gui2 = new SinglePageGUI(InventoryType.CHEST_1_ROW, Component.text("test"));
        GUI gui3 = new SinglePageGUI(InventoryType.CHEST_5_ROW, Component.text("test"));
    }

    @Test
    public void testAddSection() {
        GUI gui = new SinglePageGUI(InventoryType.CHEST_2_ROW, Component.text("test"));
